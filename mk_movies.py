...
#             output_location='../wavefront_movie_outputs/', gif_name_str='Test_atten_func', title='Upper Mantle atten', load_image='Al.png',
...
ewm.mk_mov(epi_dist=80, theta_earthquake=-32, depth_earthquake=0, propagation_time=1800, seis_channel='BXT', filter_params=[],
            ...
            output_location='../wavefront_movie_outputs/', gif_name_str='ScS_CMB', title='Investigating the Core-Mantle Boundary', load_image='Jenny.png',
...
ewm.mk_mov(epi_dist=145, theta_earthquake=-18, depth_earthquake=0, propagation_time=1400, seis_channel='BXZ', filter_params=[],
            ...
            output_location='../wavefront_movie_outputs/', gif_name_str='Core_Diff', title='Core diffracted waves', load_image='Li.png',
...
ewm.mk_mov(epi_dist=130, theta_earthquake=-18, depth_earthquake=0, propagation_time=1800, seis_channel='BXZ', filter_params=[],
            ...
            output_location='../wavefront_movie_outputs/', gif_name_str='Disc_OC', title='Discovery of the liquid outer core', load_image='Oldham.png',
...
ewm.mk_mov(epi_dist=179, theta_earthquake=78, depth_earthquake=0, propagation_time=1800, seis_channel='BXZ', filter_params=[],
            ...
            output_location='../wavefront_movie_outputs/', gif_name_str='Full_Wavefield', title='Complex P and S waves', load_image='vault.jpg',
