...
evtlongitude=0
evtdepth=10000
source = instaseis.Source.from_strike_dip_rake(latitude=evtlatitude, longitude=evtlongitude, depth_in_m=evtdepth, strike=45,dip=45, rake=90, M0=1E12, sliprate=3, dt=0.1, origin_time=EQ_time)
